...
#------------------------------------------------------
#---------------logic 8 a started----------9:12--------------------MEDB_GRP_CHNL--------------------------9:18---
...
CHNL_ITEMRH_CLIENTRH_MERGE['MAIL_RETAIL_CDE']=np.where(CHNL_ITEMRH_CLIENTRH_MERGE['PRODUCT_ID']==1,"R","O")
...
GRPCHNL_ITEMRH_CLIENTRH_MERGE['MAIL_RETAIL_CDE']=np.where(GRPCHNL_ITEMRH_CLIENTRH_MERGE['PRODUCT_ID']==1,"R","O")
...
GRPCHNL_ITEMRH_CLIENTRH_MERGE3['MAIL_RETAIL_CDE']=np.where(GRPCHNL_ITEMRH_CLIENTRH_MERGE3['PRODUCT_ID']==1,"R","O")
...
# --------------RENAME-----
GRPCHNL_ITEMRH_CLIENTRH_MERGE3_FIL3.rename(columns={"FORMULARY_ID"=='FORMULARY_ID_V1'},inplace=True)
